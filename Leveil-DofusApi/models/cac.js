...
module.exports = (sequelize, DataTypes) => {
  const cac = sequelize.define('cac', {
    type_cac: DataTypes.STRING,
    img: DataTypes.STRING,
    name: DataTypes.STRING,
    tac: DataTypes.INTEGER,
    dmg: DataTypes.INTEGER,
    deg_neutre1: DataTypes.STRING,
    deg_neutre2: DataTypes.STRING,    
    deg_neutre3: DataTypes.STRING,
    deg_feu1: DataTypes.STRING,
    deg_air1: DataTypes.STRING,
    deg_terre1: DataTypes.STRING,
    deg_eau1: DataTypes.STRING,
  ...
  cac.associate = function(models) {
    cac.hasMany(models.perso)
  };
  return cac;
};